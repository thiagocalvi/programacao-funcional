...
pub fn processa_dados_examples() {
  check.eq(processa_dados(""), Error(QuantidadeInvalidaParametros))
...
/// em uma tupla, caso tenha algum, erro retorna o erro 
...
/// caso contrario retorna uma tupla com os dois times em estruturas "Time"
